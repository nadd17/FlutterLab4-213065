...
import 'package:flutter_lab_4/widgets/map_widget.dart';
...
class _EventDetailsDialogState extends State<EventDetailsDialog> {
  ...
  void initState() {
    super.initState();
    _selectedLocation =
        widget.exam.location ?? const LatLng(42.0040144, 21.4086502);
  }
  ...
  Future<void> _addLocationBasedReminder() async {
    ...
    if (notificationTime.isAfter(DateTime.now())) {
      ...
      setState(() {
        widget.exam.hasLocationReminder = true;
      });
        ...
        child: Column(
          ...
          children: [
            ...
            widget.exam.location != null
                ? MapWidget(location: widget.exam.location!)
            ...
            if (widget.exam.location != null)
              widget.exam.hasLocationReminder
                  ? const Text(
